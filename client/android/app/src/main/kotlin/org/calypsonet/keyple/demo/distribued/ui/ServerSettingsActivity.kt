...
import org.calypsonet.keyple.demo.distribued.rest.KeypleSyncEndPointClient
import org.calypsonet.keyple.demo.distribued.rest.RestClient
...
class ServerSettingsActivity : AbstractDemoActivity() {
    ...
    @Inject
    lateinit var keypleEndpointClient: KeypleSyncEndPointClient
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ping_btn.setOnClickListener {
            if (validateEntries(false)) {
                val serverUrl = server_protocol_edit.text.toString() + server_ip_edit.text.toString() + ":" + server_port_edit.text.toString()
                Timber.i("Loaded Rest client with URL: $serverUrl")
                val testKeypleEnpoindClient = KeypleSyncEndPointClient(
                    Retrofit.Builder()
                        .baseUrl(serverUrl)
                ...
                disposables.add(testKeypleEnpoindClient
                    .ping()
