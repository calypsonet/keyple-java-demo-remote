...
import org.calypsonet.keyple.demo.reload.remote.android.network.RestClient
...
class RestModule {
  ...
  @Provides
  @AppScoped
  fun provideKeypleSyncEndpointClient(prefData: SharedPrefData): KeypleSyncEndPointClient {
    val serverUrl =
