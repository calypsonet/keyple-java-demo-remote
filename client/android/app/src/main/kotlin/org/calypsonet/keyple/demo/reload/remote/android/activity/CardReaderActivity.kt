...
import org.calypsonet.keyple.demo.reload.remote.service.ticketing.model.CardTitle
          ...
          initOmapiReader {
            GlobalScope.launch {
              remoteServiceExecution(
                  selectedDeviceReaderName, pluginType, keypleServices.aidEnums, null)
            }
          }
        }
        DeviceEnum.WEARABLE -> {
    ...
    withContext(Dispatchers.IO) {
      try {
        val transactionManager =
            keypleServices.getTransactionManager(selectedDeviceReaderName, aidEnums, protocol)
