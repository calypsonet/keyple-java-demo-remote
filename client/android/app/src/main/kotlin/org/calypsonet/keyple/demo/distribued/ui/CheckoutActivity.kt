...
class CheckoutActivity : AbstractDemoActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedTicketPriorityCode = PriorityCode.valueOf(intent.getByteExtra(
            SelectTicketsActivity.SELECTED_TICKET_PRIORITY_CODE, PriorityCode.MULTI_TRIP_TICKET.code))
